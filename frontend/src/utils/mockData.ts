...
export const mockTimeline: TimelineEntry[] = [
  {
    ...
    description: '"Designing for Student Communities" is now live.',
    time: "2h ago",
    type: "announcement",
  },
  {
    id: "t2",
    title: 'Project "Aurora" reached 70%',
    description: "Progress milestone hit by the frontend squad.",
    time: "5h ago",
    type: "project",
  },
  {
    ...
    description: "AI Workshop scheduled for Friday at 3 PM.",
    time: "1d ago",
    type: "event",
  },
  {
    id: "t4",
    title: "Weekly sync completed",
    description: "Leads reviewed roadmap and assigned tasks.",
    time: "2d ago",
    type: "meeting",
  },
];
...
export const mockProjects: Project[] = [
  {
    ...
    description: "Unified component library for all club apps.",
    progress: 72,
    members: 6,
    status: "active",
    dueDate: "Aug 12",
  ...
  },
  {
    ...
    description: "Registration, judging, and leaderboard platform.",
    progress: 45,
    members: 8,
    status: "active",
    dueDate: "Sep 03",
  ...
  },
  {
    ...
    description: "Monthly digest of achievements and events.",
    progress: 90,
    members: 3,
    status: "review",
    dueDate: "Jul 28",
  ...
  },
  {
    id: "p4",
    name: "Mentor Match",
    description: "Pairing juniors with senior mentors.",
    progress: 20,
    members: 4,
    status: "planning",
    dueDate: "Oct 01",
...
export const mockAnnouncements: Announcement[] = [
  {
    id: "a1",
    title: "Inter-club Hackathon Registrations Open",
    body: "Form teams of 4 and register before the deadline to participate in the 36-hour hackathon.",
    author: "Club Lead",
    date: "2h ago",
    priority: "high",
  },
  {
    id: "a2",
    title: "Monthly Budget Report Published",
    body: "Q2 spending report is available for review in the finance section.",
    author: "Treasurer",
    date: "1d ago",
    priority: "normal",
  },
  {
    ...
    body: "Photos from the cultural night are now in the gallery.",
    author: "Media Team",
    date: "3d ago",
    priority: "low",
  },
...
export const mockNotifications: NotificationItem[] = [
  {
    ...
    description: "Hackathon Kickoff starts in 30 minutes.",
    time: "10m ago",
    read: false,
    variant: "info",
  },
  {
    ...
    description: 'Aarav mentioned you in "Aurora Design System".',
    time: "1h ago",
    read: false,
    variant: "info",
  },
  ...
  },
  {
    ...
    description: "Budget request awaiting coordinator approval.",
    time: "1d ago",
    read: true,
    variant: "warning",
  },
...
export function buildMockCalendar(eventsList?: any[]): CalendarDay[] {
  ...
  for (let i = 0; i < offset; i++)
    days.push({ day: 0, events: 0, isToday: false, inMonth: false });
  for (let d = 1; d <= 31; d++) {
    days.push({
      day: d,
...
export const mockMemberUser: User = {
  ...
  avatarUrl:
    "https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=256&h=256&fit=crop",
  skills: ["React", "TypeScript", "Figma", "Python", "Git"],
  achievements: [
    {
      id: "ac1",
      title: "Best Project Award",
      description: "Won best project at InnovateFest.",
      date: "2025-04-22",
    },
    {
      id: "ac2",
      title: "Active Contributor",
      description: "Contributed to 5+ open-source club projects.",
      date: "2025-03-10",
    },
  ],
  badges: [
...
export const mockLeadUser: User = {
  ...
  achievements: [
    {
      id: "ac1",
      title: "Won Inter-University Hackathon",
      description: "1st place out of 64 teams.",
      date: "2025-03-14",
    },
    {
      id: "ac2",
      title: "Organized 500+ attendee tech fest",
      description: "Led logistics for InnovateFest.",
      date: "2025-04-22",
    },
    {
      id: "ac3",
      title: "Published 8 technical blogs",
      description: "Series on design systems and DX.",
      date: "2025-05-10",
    },
  ],
  badges: [
...
export const mockFacultyUser: User = {
  ...
  avatarUrl:
    "https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=256&h=256&fit=crop",
...
export const mockClubMembers: ClubMember[] = [
  ...
  },
  {
    ...
    status: "active",
    avatarUrl:
      "https://images.pexels.com/photos/91227/pexels-photo-91227.jpeg?auto=compress&cs=tinysrgb&w=128&h=128&fit=crop",
  },
  {
    id: "cm3",
    name: "Diya Patel",
    ...
    status: "active",
    avatarUrl:
      "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=128&h=128&fit=crop",
  },
  {
    id: "cm4",
    name: "Kabir Nair",
...
export const mockReports: ReportItem[] = [
  {
    id: "r1",
    title: "Developers Club Monthly Report",
    club: "Developers Club",
    type: "monthly",
    date: "Jul 01",
    status: "approved",
  ...
  {
    id: "r2",
    title: "InnovateFest Event Report",
    club: "Developers Club",
    type: "event",
    date: "Jun 28",
    status: "reviewed",
  ...
  {
    id: "r4",
    title: "Robotics Showcase Activity Log",
    club: "Robotics Club",
    type: "activity",
    date: "Jun 25",
    status: "submitted",
...
export const mockFacultyTimeline: TimelineEntry[] = [
  {
    id: "ft1",
    title: "Approved Hackathon event",
    description: "Inter-Club Hackathon approved for July 25.",
    time: "1h ago",
    type: "event",
  },
  {
    id: "ft2",
    title: "New club proposal received",
    description: "Photography Club submitted for approval.",
    time: "4h ago",
    type: "announcement",
  },
  {
    id: "ft3",
    title: "Budget request reviewed",
    description: "Developers Club Q3 equipment budget under review.",
    time: "1d ago",
    type: "project",
  },
  {
    id: "ft4",
    title: "Monthly reports deadline",
    description: "All clubs must submit by end of month.",
    time: "2d ago",
    type: "meeting",
  },
];
...
export const mockBlogPosts = [
  {
    id: "bl1",
    title: "Designing for Student Communities",
    author: "Aarav Mehta",
    date: "2h ago",
    readTime: "6 min",
    excerpt:
      "How we built a design system that scales across 40+ student clubs without losing soul.",
    cover:
      "https://images.pexels.com/photos/196645/pexels-photo-196645.jpeg?auto=compress&cs=tinysrgb&w=800",
  },
  {
    id: "bl2",
    title: "Shipping in Semesters",
    author: "Diya Sharma",
    date: "1d ago",
    readTime: "4 min",
    excerpt:
      "A framework for student projects that survive handoff and graduation.",
    cover:
      "https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=800",
  },
  {
    id: "bl3",
    title: "The Anatomy of a Great Hackathon",
    author: "Kabir Nair",
    date: "3d ago",
    readTime: "8 min",
    excerpt:
      "Lessons from running 12 hackathons — what works, what burns out, what to skip.",
    cover:
      "https://images.pexels.com/photos/7988079/pexels-photo-7988079.jpeg?auto=compress&cs=tinysrgb&w=800",
  },
  {
    id: "bl4",
    title: "Why Clubs Need Product Managers",
    author: "Ananya Reddy",
    date: "5d ago",
    readTime: "5 min",
    excerpt: "Treating clubs like mini product teams changes everything.",
    cover:
