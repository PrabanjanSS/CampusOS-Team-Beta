        ...
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-1.5 text-sm text-ink-soft">
              {user?.club && (
                <>
                  <span className="font-medium text-ink">{user.club}</span>{" "}
                  ·{" "}
                </>
              )}
          ...
          <div className="flex gap-2.5">
            <Link to="/app/announcements">
              <Button variant="secondary" leftIcon="Megaphone" size="md">
                Announce
              </Button>
            </Link>
            <Link to="/app/events">
              <Button leftIcon="Plus" size="md" magnetic>
                Create Event
              </Button>
            </Link>
          </div>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-ink-soft">
                        Submitted by {a.submittedBy} · {a.submittedDate}
                      </p>
                    </div>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          toast({
                            ...
                            description: `Viewing details for "${a.title}".`,
                            variant: "info",
                          })
                        }
                      >
          ...
          <FadeIn delay={0.22}>
            <Card>
              <CardHeader
                ...
                subtitle="What's been happening in your club"
              />
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                },
                {
                  ...
                  value: 4,
                  icon: Bell,
                  color: "bg-sand/30 text-[#8a6d3b]",
                },
                {
                  label: "Points earned",
                  value: 320,
                  icon: TrendingUp,
                  color: "bg-warning/15 text-[#b07314]",
                },
              ].map((c, i) => (
                <motion.div
                  key={c.label}
                ...
                >
                  <span
                    className={`flex h-9 w-9 items-center justify-center rounded-xl ${c.color}`}
                  >
            ...
            <Card>
              ...
              <div className="mt-3 flex items-center gap-2 border-t border-border-soft pt-3">
                ...
                <span className="text-xs text-ink-soft">
                  +{(user?.teamSize ?? 24) - 4} more members
                </span>
              </div>
            </Card>
          </FadeIn>
              ...
              <div className="space-y-2.5">
                {[
                  ...
                  .map((member) => (
                    <div
                      key={member.name}
                      className="flex items-center justify-between rounded-xl border border-border-soft/60 bg-white p-3 shadow-sm"
                    >
                      <div className="flex items-center gap-3">
                        <Avatar
                          name={member.name}
