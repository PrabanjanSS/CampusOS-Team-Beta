...
export default function MembersPage() {
  ...
  const depts = [
    "All",
    ...Array.from(new Set(members.map((m: any) => m.department))),
  ];
        ...
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-1.5 text-sm text-ink-soft">
              Review and coordinate student membership details, roles, and
              status.
            </p>
          </div>
          <Button
              ...
              >
                <div>
                  ...
                  <div className="mt-4 text-left">
                    ...
                    <p className="text-sm font-medium text-navy/80 mt-0.5">
                      {m.role}
                    </p>
        ...
        >
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <label className="label-base font-semibold block mb-1.5">
                  Department *
                </label>
                <Dropdown
                  value={department}
