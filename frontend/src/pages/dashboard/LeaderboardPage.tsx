      ...
      <FadeIn>
        <div>
          ...
          <p className="mt-1 text-sm text-ink-soft">
            Top contributors across all clubs this semester.
          </p>
        </div>
      </FadeIn>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <p className="mt-1 text-sm text-ink-soft">{p.club}</p>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-1 text-sm text-ink-soft">points</p>
                  </div>
                </div>
              </motion.div>
            );
          ...
          <div className="divide-y divide-border-soft">
            {rest.map((p, i) => (
              <StaggerItem key={p.rank}>
                ...
                >
                  <span className="w-8 text-center text-sm font-bold text-ink-soft">
                    {p.rank}
                  </span>
                  ...
                  <span className="w-20 text-right text-sm font-bold text-navy">
                    {p.points.toLocaleString()}
                  </span>
                </motion.div>
              </StaggerItem>
