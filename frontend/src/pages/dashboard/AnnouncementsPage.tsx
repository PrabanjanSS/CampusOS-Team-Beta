...
const priorityOptions = [
  {
    value: "high",
    label: "High",
    color: "bg-danger/10 text-danger border-danger/25 hover:bg-danger/15",
    active: "bg-danger text-white border-danger shadow-md",
  },
  {
    value: "normal",
    label: "Normal",
    color: "bg-warning/10 text-[#b07314] border-warning/30 hover:bg-warning/20",
    active: "bg-warning text-ink border-warning shadow-md",
  },
  {
    value: "low",
    label: "Low",
    color:
      "bg-ink-soft/8 text-ink-soft border-border-soft hover:bg-ink-soft/12",
    active: "bg-ink-soft/80 text-white border-ink-soft shadow-md",
  },
] as const;
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2">
                    <span
                      className={`h-1.5 w-1.5 rounded-full ${priorityDot[a.priority as keyof typeof priorityDot]}`}
                    />
                    ...
                    <Badge
                      tone={
                        priorityTone[a.priority as keyof typeof priorityTone]
                      }
                    >
                      {a.priority}
                    </Badge>
