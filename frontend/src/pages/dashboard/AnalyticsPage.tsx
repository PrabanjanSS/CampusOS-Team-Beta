...
export default function AnalyticsPage() {
  const activeClubsCount = mockClubOverviews.filter(
    (c) => c.status === "active",
  ).length;
        ...
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-ink-soft">
              Track student engagement, event metrics, and club rankings.
            </p>
          </div>
        </div>
      </FadeIn>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <FadeIn delay={0.12} className="md:col-span-2">
          <Card>
            <CardHeader
              ...
              subtitle="Event registrations vs. attendance rate"
            />
              ...
              <div className="absolute inset-x-8 bottom-0 top-4 flex items-end justify-between px-2">
                {[
                  ...
                  >
                    ...
                    <span className="text-[0.68rem] font-semibold text-ink-soft">
                      {item.month}
                    </span>
                  </div>
                ))}
            ...
            <div className="mt-4 flex items-center justify-center gap-4 text-xs">
              <span className="flex items-center gap-1.5">
                <span className="h-2.5 w-2.5 rounded bg-navy" /> Event
                Registrations
              </span>
              <span className="flex items-center gap-1.5">
                <span className="h-2.5 w-2.5 rounded bg-success" /> Attendance
                Rate (%)
              </span>
            </div>
          </Card>
        ...
        <FadeIn delay={0.16}>
          <Card>
            <CardHeader
              title="Club Rankings"
              subtitle="Based on performance score"
            />
