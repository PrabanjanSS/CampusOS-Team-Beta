      ...
      <FadeIn>
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              ...
              {user?.overseesClubs && (
                <>
                  ...
                  <span className="font-medium text-ink">
                    {user.overseesClubs.length} clubs
                  </span>
                </>
              )}
            </p>
          ...
          <div className="flex gap-2.5">
            <Link to="/app/reports">
              <Button variant="secondary" leftIcon="FileText" size="md">
                Reports
              </Button>
            </Link>
            <Link to="/app/approvals">
              <Button leftIcon="CheckSquare" size="md" magnetic>
                Review Approvals
              </Button>
            </Link>
          </div>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-ink-soft">
                        Lead: {club.lead} · {club.members} members ·{" "}
                        {club.eventsThisMonth} events this month
                      </p>
                    </div>
                ...
                {mockPendingApprovals.map((a, i) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-ink-soft">
                        From: {a.submittedBy} · {a.submittedDate}
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          toast({
                            ...
                            description: `Approved "${a.title}" successfully.`,
                            variant: "success",
                          })
                        }
                      >
          ...
          <FadeIn delay={0.22}>
            <Card>
              <CardHeader
                ...
                subtitle="Recent actions across all clubs"
              />
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-ink-soft">
                        {d.clubs} clubs · {d.members} members
                      </p>
                    </div>
                  </motion.div>
                ))}
            ...
            <Card>
              ...
              <div className="space-y-3">
                ...
                <p className="mt-1 rounded-lg bg-cream-100 px-3 py-2 text-xs text-ink-soft">
                  Budget data is placeholder — connect your finance system for
                  live figures.
                </p>
              </div>
            </Card>
                  ...
                  },
                  {
                    ...
                    onClick: () =>
                      toast({
                        title: "Analytics",
                        description:
                          "Analytics summary: All 4 clubs are active and performing well.",
                        variant: "info",
                      }),
                  },
                ].map((a, i) => {
