    ...
    <div className="relative min-h-screen overflow-hidden bg-cream">
      ...
      >
        ...
        <div className="hidden items-center gap-8 text-sm font-medium text-ink-soft md:flex">
          ...
          <a href="#roles" className="transition-colors hover:text-navy">
            Roles
          </a>
          <a href="#stats" className="transition-colors hover:text-navy">
            Impact
          </a>
        </div>
        <Link
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 pb-10 pt-16 text-center sm:pt-24">
        ...
        >
          <span className="block text-ink">One Platform.</span>

          <span className="block text-navy">Every Club.</span>

          <span className="block text-[#5f6673]">Every Achievement.</span>
        </motion.h1>
        ...
        >
          {APP_NAME} unifies events, projects, blogs, galleries, and
          leaderboards into one elegant platform — built for every campus, every
          club, every role.
        </motion.p>
        ...
        <div className="mb-10 text-center">
          ...
          <FadeUpItem delay={0.08}>
            <p className="mx-auto mt-3 max-w-xl text-ink-soft">
              Select how you participate in campus life. Each experience is
              tailored precisely to your responsibilities.
            </p>
          </FadeUpItem>
        </div>
          ...
          {(Object.keys(ROLES) as Role[]).map((roleKey, i) => {
            ...
            return (
              ...
              >
                <Link
                  to={role.loginPath}
                  className="gradient-border group block rounded-3xl"
                >
                  <div className="relative overflow-hidden rounded-3xl border border-white/60 bg-white/70 p-7 shadow-card backdrop-blur-xl transition-shadow duration-300 group-hover:shadow-lift">
                    ...
                    <div className="relative">
                      <div
                        className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${role.gradient} text-white shadow-soft transition-transform duration-300 group-hover:rotate-3 group-hover:scale-110`}
                      >
        ...
        <div className="mb-10 text-center">
          ...
          <FadeUpItem delay={0.08}>
            <p className="mx-auto mt-3 max-w-lg text-ink-soft">
              Purpose-built modules that grow with your club — from day one to
              demo day.
            </p>
          </FadeUpItem>
        </div>
      ...
      <section
        id="stats"
        className="relative z-10 mx-auto max-w-5xl px-6 py-16"
      >
      ...
      <section className="relative z-10 overflow-hidden bg-cream py-24">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-ink-soft">
            Experience the vibrant life of CampusOS through hackathons, AI
            workshops, cultural festivals, club activities, competitions and
...
"
      ...
      <div className="mt-16 text-center">
        <p className="text-lg text-ink-soft">
          Every event begins with an idea. Every achievement begins with
          participation.
        </p>
