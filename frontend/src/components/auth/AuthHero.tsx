...
import { CalendarDays, Trophy, FolderKanban, Users } from "lucide-react";
    ...
    <div className="relative hidden overflow-hidden bg-gradient-to-br from-navy-800 via-navy to-navy-400 lg:flex lg:flex-col lg:justify-between lg:p-12">
      ...
      >
        ...
        <p className="mt-5 text-lg text-white/70">
          CampusOS helps students, club leads and faculty collaborate through
          events, projects, polls, announcements and much more.
        </p>
      ...
      <p className="relative text-sm text-white/40">© 2026 CampusOS</p>
    </div>
  );
}
