...
export function StatCard({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "absolute -right-6 -top-6 h-24 w-24 rounded-full opacity-50 blur-2xl transition-opacity group-hover:opacity-80",
          a.bg,
        )}
      />
      ...
      <div className="relative mt-4">
        <p className="text-3xl font-bold tracking-tight text-ink">
          ...
          {stat.suffix && (
            <span className="ml-0.5 text-lg font-semibold text-ink-soft">
              {stat.suffix}
            </span>
          )}
        </p>
