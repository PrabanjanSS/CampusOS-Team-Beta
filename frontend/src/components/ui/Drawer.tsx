      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 40%, rgba(25,55,109,0.14) 0%, rgba(15,23,42,0.50) 100%)",
          ...
          <motion.div
            ...
            style={{
              boxShadow: isLeft
                ? "8px 0 48px -8px rgba(25,55,109,0.22)"
                : "-8px 0 48px -8px rgba(25,55,109,0.22)",
            }}
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, #19376d 0%, #4f7ec4 50%, #d9a05b 100%)",
              }}
            />
              ...
              {title && (
                <div>
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, rgba(25,55,109,0.5) 0%, transparent 100%)",
                    }}
                  />
                </div>
              )}
