...
export const mockProfiles: Record<string, MemberProfile> = {
  ...
  "Diya Sharma": {
    ...
    achievements: [
      {
        id: "ac1",
        title: "UI Redesign Competition Winner",
        description: "Placed 1st in the national website redesign challenge.",
        date: "2025-02-18",
      },
    ],
    badges: [
  ...
  "Sara Khan": {
    ...
    achievements: [
      {
        id: "ac1",
        title: "Top Author Badge",
        description: "Published 10+ popular blogs and project logs.",
        date: "2025-05-02",
      },
    ],
    badges: [
  ...
  "Rohan Gupta": {
    ...
    achievements: [
      {
        id: "ac1",
        title: "RoboQuest Runner Up",
        description: "Placed 2nd in the regional autonomous rover race.",
        date: "2025-03-29",
      },
    ],
    badges: [
    ...
    achievements: [
      {
        ...
        description:
          "Maintained and migrated club infrastructure to Docker clusters.",
        date: "2025-04-12",
      },
    ],
    badges: [
  ...
  "Diya Patel": {
    ...
    achievements: [
      {
        id: "ac1",
        title: "Dribbble Feature",
        description: "Featured design layout on Dribbble community page.",
        date: "2025-01-30",
      },
    ],
    badges: [
  ...
  "Ananya Reddy": {
    ...
    achievements: [
      {
        id: "ac1",
        title: "InnovateFest Lead Planner",
        description:
          "Managed coordination and speaker lineup for 500+ attendees.",
        date: "2025-04-22",
      },
    ],
    badges: [
  ...
  "Vikram Pai": {
    ...
    achievements: [
      {
        id: "ac1",
        title: "National Debating Championship Winner",
        description: "Placed 1st overall in varsity team debates.",
        date: "2025-02-10",
      },
    ],
    badges: [
    ...
    certificates: [
      {
        id: "c1",
        title: "Rhetoric & Logic Foundations",
        issuer: "HarvardX",
        date: "2024-07-28",
      },
    ],
  ...
  "Meera Joshi": {
    ...
    achievements: [
      {
        id: "ac1",
        title: "Leetcode 500 club",
        description: "Solved 500+ data structures and algorithm questions.",
        date: "2025-03-12",
      },
    ],
    badges: [
...
export function MemberProfileModal({ memberName, onClose }: Props) {
  ...
  const profile = useMemo(() => {
    ...
    return (currentProfiles[memberName] ||
      defaultProfile(memberName)) as MemberProfile;
  }, [memberName]);
      ...
      <div className="-m-6 overflow-hidden bg-cream/35">
        ...
        <div className="relative px-6 pb-6 pt-4 bg-white border-t border-border-soft">
          ...
          <div className="mt-4 flex flex-wrap justify-center sm:justify-start gap-4 text-xs text-ink-soft border-t border-border-soft/60 pt-4">
            ...
            <span className="inline-flex items-center gap-1.5">
              <CalendarDays className="h-3.5 w-3.5" /> {profile.year}
            </span>
            <span className="inline-flex items-center gap-1.5">
              <MapPin className="h-3.5 w-3.5" /> {profile.club}
            </span>
          </div>
        </div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {profile.achievements.map((a) => (
                  ...
                  >
                    ...
                    <p className="mt-2 text-xs font-bold text-ink line-clamp-1">
                      {a.title}
                    </p>
          ...
          <div className="text-center space-y-4 py-2">
            ...
            <div>
              ...
              <p className="text-xs text-ink-soft mt-1">
                Earned on {activeAchievement.date}
              </p>
            </div>
