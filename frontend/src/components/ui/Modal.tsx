      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 40%, rgba(25,55,109,0.18) 0%, rgba(15,23,42,0.6) 100%)",
          ...
          <motion.div
            ...
            style={{
              boxShadow:
                "0 -8px 40px -8px rgba(25,55,109,0.14), 0 32px 80px -12px rgba(25,55,109,0.28), 0 0 0 1px rgba(25,55,109,0.08)",
            }}
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, #19376d 0%, #4f7ec4 50%, #d9a05b 100%)",
              }}
            />
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(25,55,109,0.12) 0%, transparent 70%)",
              }}
            />
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(217,160,91,0.14) 0%, transparent 70%)",
              }}
            />
